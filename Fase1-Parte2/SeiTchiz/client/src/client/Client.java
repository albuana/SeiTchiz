...
public final class Client {
	...
	private Client(String serverAddress, String truststore, String keystore, String keystorePass, String userID) throws NumberFormatException, IOException, KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableKeyException {
		...
		// Assumimos que o clientId são os aliases
		privateKey = CipherHandler.getPrivateKeyFromKeystore(keyStore, keystorePass, KEY_STORE_ALIAS);
		
		System.out.println("publicKey: " +keystore + ", " + keystorePass + ", " + KEY_STORE_ALIAS + "\n");
		
		publicKey = CipherHandler.getPublicKeyFromPathToKeystore(keystore, keystorePass, KEY_STORE_ALIAS, KEY_STORE_TYPE);
