...
public final class RequestHandler {
	 ...
	 * @throws ClassNotFoundException 
	 */
    public static Object post(byte[] data, String fileName, User username) throws IOException, NoSuchAlgorithmException, ClassNotFoundException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public static Object wall(String nPhotos, User username) throws HaveNoPhotosExeption, NoSuchAlgorithmException, IOException, ClassNotFoundException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public static Object like(String postID, User username) throws IOException, NoPostExeption, ClassNotFoundException, NoSuchAlgorithmException {
	 ...
	 */
	public static String addu(String newUser, String groupId, ArrayList<Object[]> userKeys, User owner) throws UserNotExistException, ClassNotFoundException, GroupException, IOException, CertificateException {
		return new AddNewMemberGroupHandler(newUser,groupId,userKeys,owner).addMember();
	}
	...
	public static PublicKey getUserPublicKey(String newUser, User user) throws UserNotOwnerException, GroupNotExistException, ClassNotFoundException, CertificateException, IOException, UserNotExistException {
		User newbie = UserCatalog.getInstance().getUser(newUser);
		if(newbie == null)
			throw new UserNotExistException();
		PublicKey pk=newbie.getPublicKey();
		return pk;
	}
	public static byte[] getEncryptedGroupKeyUser(String groupId,User user) throws UserNotOwnerException, GroupNotExistException, ClassNotFoundException, CertificateException, IOException, UserNotExistException {
		byte[] encryptedKey=GroupCatalog.getInstance().getGroup(groupId).getUserKey(user);
		return encryptedKey;
	}
	/**
	 ...
	 * @throws CertificateException 
	 */
	public static String removeu(String oldUser, String groupId, ArrayList<Object[]> userKeys, User owner) throws GroupException, IOException, UserNotExistException, ClassNotFoundException, CantRemoveOwnerExeption, CertificateException {
		return new RemoveMemberGroupHandler(oldUser, groupId, userKeys, owner).removeMember();
	}
	 ...
	 */
	public static String msg(String groupId, byte[] content,User sender) throws GroupNotExistException, IOException, ClassNotFoundException, UserDoesNotBelongToGroupException, CertificateException {
	 ...
	 * @see server.handlers.CollectMessagesHandler
	 */
	public static List<Object[]> collect (String groupID, User user) throws GroupNotExistException, IOException, ClassNotFoundException, UserDoesNotBelongToGroupException, NothingToReadException, CertificateException {
	 ...
	 */
	public static List<Object[]> history(String groupId, User user) throws GroupNotExistException, IOException, ClassNotFoundException, UserDoesNotBelongToGroupException, CertificateException, NothingToReadException {
